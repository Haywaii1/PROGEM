...
<body>
    ...
    <header class="bg-light">
        ...
        <div class="top-bar d-flex justify-content-between px-3 py-2 bg-danger text-white small">
            <div>
                Need help now? Call for a same-day consultation 📞 (021) 345-6789
            </div>
            <div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <img src="{{ asset('img/logo2.png') }}" alt="Logo" class="mb-2" style="max-height: 50px;">
                    <p>An integrated PR agency building powerful brands and nurturing talent.</p>
                </div>
                ...
                <div class="col-md-3 mb-4">
                    <h5>Contact</h5>
                    <p><i class="fas fa-map-marker-alt me-2"></i>Lagos, Nigeria & Calgary, Canada</p>
                    <p><i class="fas fa-envelope me-2"></i>progemhubconsulting@gmail.com</p>
                    <p><i class="fas fa-phone me-2"></i>+234 703 023 8199</p>
                </div>
            ...
            <div class="text-center mt-4">
                <p class="mb-0">&copy; {{ now()->year }} PROGEMHUB. All rights reserved.</p>
            </div>
        </div>
    </footer>
